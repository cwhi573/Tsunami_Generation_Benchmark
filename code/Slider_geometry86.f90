...
! *** open output file
      open(23,file='bed_elevation86.dat')
...
! *** passed variables
      ...
      integer :: jn
      real*8 :: zbot,xdif,arg,xdif0,xdif1,zbotleft,zbotright

! *** Case 85 UCant Flume (flat bottom) with elliptical slider with smoothed ends
